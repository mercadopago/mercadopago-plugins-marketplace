...
2. If it is unavailable or returns an authentication error, call `authenticate`.
...
Ask the developer (or infer from `developer-provided context`) which of these they want:
