...
```bash
node "${PLUGIN_ROOT}/scripts/validate-bricks-integration.mjs" . card-payment
node "${PLUGIN_ROOT}/scripts/validate-bricks-integration.mjs" . payment
node "${PLUGIN_ROOT}/scripts/validate-bricks-integration.mjs" . wallet
node "${PLUGIN_ROOT}/scripts/validate-bricks-integration.mjs" . status-screen
```
